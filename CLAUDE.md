...
| `tests/app.test.mjs` | End-to-end suite, ~358 checks |
...
Six bottom sheets: the **feeding editor**, the **diaper editor**, the **medicine editor**, the
**menu** (PDF summary, CSV export, JSON backup, restore, what's new, about), the **version
log**, and the **newborn basics**.
