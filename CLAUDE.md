...
| `tests/app.test.mjs` | End-to-end suite, ~387 checks |
...
Seven bottom sheets: the **feeding editor**, the **diaper editor**, the **medicine editor**, the
**menu** (PDF summary, CSV export, JSON backup, restore, send an update, paste an update, what's
new, about, vibration), the **version log**, the **newborn basics**, and **paste an update**.
